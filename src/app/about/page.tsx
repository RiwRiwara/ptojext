      ...
      <div className=" flex flex-col justify-start h-full gap-8">
        <div className=" flex flex-col container mx-auto max-w-[600px] bg-gradient-to-b from-slate-600 to-gray-400 rounded-[20px] p-4 text-white border-2 border-white shadow-lg shadow-gray-300">
          ...
          <p className="uppercase text-lg">
            ...
            asperiores facere, dolore architecto ipsum amet nemo ab consectetur
            mollitia distinctio excepturi optio voluptas repellat a quasi, cum,
            eaque perspiciatis quod? Lorem, ipsum dolor sit amet consectetur
            adipisicing elit. Sed asperiores facere, dolore architecto ipsum
            amet nemo ab consectetur mollitia distinctio excepturi optio
            voluptas repellat a quasi, cum, eaque perspiciatis quod? Lorem,
            ipsum dolor sit amet consectetur adipisicing elit. Sed asperiores
            facere, dolore architecto ipsum amet nemo ab consectetur mollitia
            distinctio excepturi optio voluptas repellat a quasi, cum, eaque
            perspiciatis quod? Lorem, ipsum dolor sit amet consectetur
            adipisicing elit. Sed asperiores facere, dolore architecto ipsum
            amet nemo ab consectetur mollitia distinctio excepturi optio
            voluptas repellat a quasi, cum, eaque perspiciatis quod? mollitia
            distinctio excepturi optio voluptas repellat a quasi, cum, eaque
            perspiciatis quod? Lorem, ipsum dolor sit amet consectetur amet nemo
            ab consectetur mollitia distinctio excepturi optio
          </p>
        </div>
      </div>
    </CommonLayout>
