...
export const LinearTimelineVisualization = ({ initialData }: LinearVisualizationProps) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200">
          ...
          <div className="space-y-3">
            <div>
              <h4 className="font-medium text-sm">What is a Timeline?</h4>
              <p className="text-sm text-gray-600">
                A timeline is a linear representation of data elements arranged sequentially. Each element has a fixed position and can be accessed directly by its index.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc text-sm text-gray-600 pl-5 space-y-1">
                <li>Access: O(1) - Direct access to any element</li>
                <li>Insert: O(n) - May require shifting elements</li>
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Arrays, linked lists, and sequential data processing such as timelines in project management, historical events, and step-by-step guides.
              </p>
            </div>
          </div>
        </div>
