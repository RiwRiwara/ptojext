...
export default function LeftMenu() {
  return (
    ...
    <div className="w-full md:w-fit md:fixed z-10 md:h-[calc(100%-50px)] flex p-4 flex-row  md:flex-col md:justify-between  overflow-auto bg-gradient-to-b from-slate-50 to-gray-200 rounded-full shadow-inner">
